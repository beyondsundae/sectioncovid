            ...
            <div className='container-fluid' style={ Style.PaddingForMenu }/>
                            ...
                            <div className='container-fluid Content' style={ Style.AreaHeightContent }>
                                <div className='row ' style={{paddingTop: "10vh", height: "82vh"}}>
                                    <div className='p-5 col-4 d-none d-md-block text-center' ref={ref}>
                                        <img 
                                            className={inView ? "animate__animated animate__bounceInDown hospital" : "d-none"}
                                            src={ Hostpital } /> {/* Hospital pic*/}
                                    </div>
                
                                    <div className='col justify-content-center Content2' ref={ref2}>
                                        <div className={inView2 ? "animate__animated animate__fadeInRight row" : "d-none"} >
